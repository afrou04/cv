...
### 既存サービスの開発・運用/新規サービの開発でフルスタックに開発【PHP/JavaScript/TypeScript】(2018年〜2019年)
...
【発揮したバリュー】
環境も何もない状態から、どういうツール、技術を選択すること。
ビジネスサイドの要件を開発に落としこみ1人で実装まで持っていくこと。
0の状態のサービスをどうやってユーザーを集め、訪れたユーザーに対してどうやってコンバージョンさせるかなどマーケティングも含めたUI・UXの改善。
資金が限られている状態で、出来るだけコストをかけないようにしながら開発をスケールさせる選択。
インフラ、DB設計、APIの実装、フロントの実装などフルスタックに1人で全ての開発をしたこと。オンラインスクール
